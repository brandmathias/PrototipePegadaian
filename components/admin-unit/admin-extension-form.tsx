...
import {
  AdminDatePicker,
  getDateAfter,
} from "@/components/admin-unit/admin-date-picker";
...
export function AdminExtensionForm({
  ...
  const [newDueDate, setNewDueDate] = useState(
    getDateAfter(currentDueDate, 30),
  );
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (
      ...
      toast({
        ...
        description:
          "Tanggal jatuh tempo baru harus lebih akhir dari tanggal yang berjalan sekarang.",
        variant: "error",
        scope: "admin-unit",
      });
      return;
    ...
    toast({
      ...
      description:
        "Tanggal jatuh tempo baru sedang diperbarui di riwayat barang.",
      variant: "info",
      scope: "admin-unit",
      duration: 2600,
    });
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          result?.message ?? "Perpanjangan belum berhasil diproses.",
        );
      }
      ...
      toast({
        ...
        description:
          "Tanggal jatuh tempo sudah diperbarui sesuai pilihan Anda.",
        variant: "success",
        scope: "admin-unit",
      });
      ...
      toast({
        ...
        description:
          error instanceof Error
            ? error.message
            : "Coba ulangi setelah memeriksa tanggal baru.",
        variant: "error",
        scope: "admin-unit",
        duration: 5600,
      });
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-2 text-center">
              ...
              <p className="mx-auto max-w-md text-[0.9rem] leading-7 text-slate-500">
                Pilih tanggal jatuh tempo baru secara langsung menggunakan
                kalender sistem.
              </p>
            </div>

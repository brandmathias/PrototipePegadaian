          ...
          {activePoint ? (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="shrink-0 whitespace-nowrap rounded-full bg-[#fff7e6] px-2.5 py-1 text-[0.64rem] font-black leading-none text-[#c97900] dark:bg-amber-300/12 dark:text-amber-100">

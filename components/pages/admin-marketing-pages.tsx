...
import {
  ...
  shouldUseDedicatedMobilePrintRoute,
          ...
          <div className="grid gap-3 print:hidden">
            {auction.transactionId && onPrintReceipt ? (
              <VickreyReceiptPrintButton
                ...
                mobilePrintHref={`/admin/transaksi/${auction.transactionId}/nota?output=print`}
...
function FixedPriceReceiptInlinePrint({
  ...
  return (
    <TransactionReceiptInlinePrint
      ...
      label={label}
      mobilePrintHref={
        auction.transactionId ? `/admin/transaksi/${auction.transactionId}/nota?output=print` : undefined
      }

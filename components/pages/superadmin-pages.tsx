...
function SuperAdminFixedPriceProgressPanel({
  ...
  const paymentFailed = ["DITOLAK_BUKTI", "GAGAL"].includes(
    session.transactionStatus ?? "",
  );
  const hasTransaction = Boolean(session.transactionId);
  ...
  const steps = [
    ...
    },
    {
      ...
      actor:
        fulfilled
          ? completionActor
          : verified && session.handoverProofUrl
            ? buyerActor
            : null,
...
function SuperAdminFixedPriceWorkspace({
  ...
  const statusTitle = paymentFailed
  ...
  return (
    ...
    >
      ...
      <section
        ...
        data-testid={
          paymentFailed ? "superadmin-fixed-price-payment-audit" : undefined
        }
      >
        <div className="flex items-center gap-3">
          <span
...
function SuperAdminAssetTimeline({
  ...
  return (
    <aside
      ...
      data-testid="superadmin-asset-timeline"
    >
...
export function SuperAdminUnitBarangDetailPage({
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-4" data-testid="superadmin-item-audit-stack">
        <section
          className="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-[0_12px_28px_rgba(15,23,42,0.04)]"
          data-testid="superadmin-item-detail-main-card"
        >

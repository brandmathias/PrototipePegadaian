                ...
                <div
                  className={cn(
                    ...
                    isCompactBlacklistNotice
                      ? "w-full overflow-hidden text-ellipsis whitespace-nowrap rounded-xl px-4 py-3 text-[clamp(0.74rem,1vw,0.9rem)] font-semibold leading-5 tracking-tight text-justify [text-align-last:justify]"

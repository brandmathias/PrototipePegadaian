...
export const BUYER_REGISTRATION_DUPLICATE_MESSAGE =
  "Registrasi tidak dapat dilakukan. Salah satu data yang Anda masukkan sudah terdaftar atau digunakan dengan akun yang memiliki riwayat pelanggaran. Hubungi unit terkait untuk informasi lebih lanjut.";

export const BUYER_REGISTRATION_BLACKLIST_MESSAGE =
  "Identitas Anda sedang dalam masa pembatasan akses sistem. Silakan kunjungi unit terkait untuk informasi lebih lanjut.";

...
export const WANEA_REAL_VIOLATION_SCENARIO: WaneaRealViolationIncident[] = [
  incident({
    ...
    itemEnteredAt: date("2026-04-12T09:00:00+07:00"),
    auctionStartsAt: date("2026-04-22T09:00:00+07:00"),
    auctionEndsAt: date("2026-04-22T10:00:00+07:00"),
    violationOccurredAt: date("2026-04-23T10:00:00+07:00"),
    dueDate: date("2026-08-10T09:00:00+07:00"),
    bids: [
      { bidderEmail: "rendra@gmail.com", amount: 17_250_000, submittedAt: date("2026-04-22T09:11:00+07:00") },
      { bidderEmail: "anindita@gmail.com", amount: 16_900_000, submittedAt: date("2026-04-22T09:22:00+07:00") },
      { bidderEmail: "lazuardi@gmail.com", amount: 16_550_000, submittedAt: date("2026-04-22T09:34:00+07:00") },
      { bidderEmail: "savera@gmail.com", amount: 16_250_000, submittedAt: date("2026-04-22T09:43:00+07:00") },
      { bidderEmail: "mahesa@gmail.com", amount: 16_050_000, submittedAt: date("2026-04-22T09:52:00+07:00") }
    ],
    media: {
  ...
  incident({
    ...
    itemEnteredAt: date("2026-07-08T10:00:00+07:00"),
    auctionStartsAt: date("2026-07-18T10:00:00+07:00"),
    auctionEndsAt: date("2026-07-18T11:00:00+07:00"),
    violationOccurredAt: date("2026-07-19T11:00:00+07:00"),
    dueDate: date("2026-11-05T10:00:00+07:00"),
    bids: [
      { bidderEmail: "rendra@gmail.com", amount: 24_200_000, submittedAt: date("2026-07-18T10:10:00+07:00") },
      { bidderEmail: "mahesa@gmail.com", amount: 23_850_000, submittedAt: date("2026-07-18T10:21:00+07:00") },
      { bidderEmail: "anindita@gmail.com", amount: 23_450_000, submittedAt: date("2026-07-18T10:32:00+07:00") },
      { bidderEmail: "lazuardi@gmail.com", amount: 23_050_000, submittedAt: date("2026-07-18T10:43:00+07:00") },
      { bidderEmail: "savera@gmail.com", amount: 22_850_000, submittedAt: date("2026-07-18T10:51:00+07:00") }
    ],
    media: {
  ...
  incident({
    ...
    itemEnteredAt: date("2026-07-10T14:00:00+07:00"),
    auctionStartsAt: date("2026-07-20T14:00:00+07:00"),
    auctionEndsAt: date("2026-07-20T15:00:00+07:00"),
    violationOccurredAt: date("2026-07-21T15:00:00+07:00"),
    dueDate: date("2026-11-07T14:00:00+07:00"),
    bids: [
      { bidderEmail: "anindita@gmail.com", amount: 14_000_000, submittedAt: date("2026-07-20T14:09:00+07:00") },
      { bidderEmail: "lazuardi@gmail.com", amount: 13_650_000, submittedAt: date("2026-07-20T14:22:00+07:00") },
      { bidderEmail: "savera@gmail.com", amount: 13_300_000, submittedAt: date("2026-07-20T14:36:00+07:00") },
      { bidderEmail: "mahesa@gmail.com", amount: 12_950_000, submittedAt: date("2026-07-20T14:48:00+07:00") }
    ],
    media: {
